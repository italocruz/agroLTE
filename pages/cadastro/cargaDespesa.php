...
$sqlP = "SELECT valor FROM pagamento where idCarga = ? AND tipoPagamento = '4'";
$qP = $pdo->prepare($sqlP);
            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="cargaDespesa.php?id=<?php echo $carga ?>" method="post">
                            <div class="card-body">

                                <div class="row">
                                    <div class="col-4">
                                        <div class="form-group">
                                            <input type="hidden" name="tipoPagamento" required="" value="4"> <!-- valor 4 = estiva -->
                ...
                <section class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1>Despesas: R$ <?php echo number_format($valorP, 2, ',', '.');?></h1>
                            </div>
                        </div>
                    </div><!-- /.container-fluid -->
                </section>
                ...
                $pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
                //$hoje = date("Y-m-d");
                $sql = 'SELECT * FROM pagamento WHERE idCarga = :idCarga AND tipoPagamento = "4" ORDER BY data DESC';
                $q = $pdo->prepare($sql);
