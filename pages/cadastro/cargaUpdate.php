...
if (!empty($_POST)) {
    ...
    $sql = "UPDATE carga  set data = ?, peso = ?, motorista = ?, valorSaca = ?, qtdSacas50 = ?, qtdSacas25 = ? WHERE id = ?";
    $q = $pdo->prepare($sql);
    $q->execute(array($data, $peso, $motorista, $valorSaca, $qtdSacas50, $qtdSacas25, $id));
    Banco::desconectar();
            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="cargaUpdate.php?id=<?php echo $id ?>" method="post">
                            <div class="card-body">
